...
public class TankMammouth extends MovibleEntity{
    Map<Float, PImage> imagePositions;
    Sprite sprite;
    public TankMammouth(int idTeam, int idType, int life, PVector position, int dmgAttack, float fireRate, float speedMovement, PApplet p, PImage map, EventManager event, PVector camera) {
        super(idTeam, idType, life, position, dmgAttack, fireRate, speedMovement, p, map, event, camera);
    ...
    public void setup() {
        ...
        this.sprite.loadFromFile(Path.TANK_MAMMOUTH);
        int x = 0;
